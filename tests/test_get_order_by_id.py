...
class TestGetOrderById:
    ...
    @allure.description(
        'Позитивный сценарий тестирования ручки "Получить заказ по его номеру" GET /api/v1/orders/track.'
    ...
    @allure.description(
        'Негативный сценарий тестирования ручки "Получить заказ по его номеру" GET /api/v1/orders/track.'
    ...
    def test_get_order_without_id(self):
        ...
        assert response.json()['message'] == EM.track_order_error_400
    ...
    def test_get_order_no_exist_id(self):
        ...
        assert response.json()['message'] == EM.track_order_error_404
